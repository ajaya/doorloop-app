  ...
  module CLI
    class Payment < Base
      ...
      def receive
        ...
        run_with_session do
          result = DoorloopMcp.service.receive_payment(
      ...
      def confirm_payment(lease_id, tenant_name, amount, raw: false)
        ...
        matching = DoorloopMcp.service.confirm_payment(lease_id: lease_id, amount: amount)
        ...
        result = DoorloopMcp.service.send_payment_confirmation(transactions: matching, tenant_name: tenant_name)
        if result[:sent]
