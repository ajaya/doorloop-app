...
class AgentMailClientTest < Minitest::Test
  ...
  def setup
    DoorLoopApp.configuration.agentmail_api_key = "test-api-key"
    DoorLoopApp.configuration.agentmail_inbox_id = "inbox_123"
  end

  def teardown
    DoorLoopApp.configuration.agentmail_api_key = nil
    DoorLoopApp.configuration.agentmail_inbox_id = nil
  end
  ...
  def test_raises_without_api_key
    ...
    error = assert_raises(RuntimeError) do
      DoorLoopApp::AgentMail::Client.new
    end
  ...
  def test_extract_code_from_text_body
    ...
    assert_equal "031524", DoorLoopApp::AgentMail::Client.extract_verification_code(message)
  end
  ...
  def test_extract_code_from_html_body
    ...
    assert_equal "987654", DoorLoopApp::AgentMail::Client.extract_verification_code(message)
  end

  def test_extract_code_from_extracted_text
    message = { "extracted_text" => "verification code is: 112233" }
    assert_equal "112233", DoorLoopApp::AgentMail::Client.extract_verification_code(message)
  end
  ...
  def test_extract_code_prefers_text_over_html
    ...
    assert_equal "111111", DoorLoopApp::AgentMail::Client.extract_verification_code(message)
  end

  def test_extract_code_returns_nil_when_no_match
    message = { "text" => "Hello, this is a regular email." }
    assert_nil DoorLoopApp::AgentMail::Client.extract_verification_code(message)
  end

  def test_extract_code_returns_nil_for_empty_message
    assert_nil DoorLoopApp::AgentMail::Client.extract_verification_code({})
  end
